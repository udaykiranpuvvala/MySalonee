...
class ForgotPasswordRepository {
    fun getForgotPasswordResponse(jsonObjectParams: JsonObject): MutableLiveData<JsonElement?> {
        val loginResponse = MutableLiveData<JsonElement?>()

        RetrofitInstance.create().forgotPassword(jsonObjectParams).enqueue(object : Callback<JsonElement> {
