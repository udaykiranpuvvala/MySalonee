...
class ChangePasswordRepository {
    fun getChangePasswordResponse(jsonObjectParams: JsonObject): MutableLiveData<JsonElement?> {
        val loginResponse = MutableLiveData<JsonElement?>()

        RetrofitInstance.create().changePassword(jsonObjectParams).enqueue(object : Callback<JsonElement> {
